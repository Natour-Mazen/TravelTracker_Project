...
public class SaveTripActivityStep4 extends AppCompatActivity {

    private static final String LOG_TAG = "SaveTripActivityStep4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set layout
        setContentView(R.layout.activity_save_trip_step4);
        ...
        tripRepository = new TripRepository(SaveTripActivityStep4.this.getApplication());
    ...
    private void redirectToHomeActivity() {
        Intent intent = new Intent(SaveTripActivityStep4.this, HomeActivity.class);
    ...
    private void redirectToDetailsActivity() {
        ...
        updateTripDetails();
        Intent intent = new Intent(SaveTripActivityStep4.this, DetailsTripActivity.class);
